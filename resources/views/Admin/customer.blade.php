                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-data-feature">                              
                                <a href="{{url('admin/customer/customer_details/')}}/{{$list->id}}"><button type="button" class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="View">
